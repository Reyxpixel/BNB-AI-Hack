...
export declare const greenfieldAminoConverters: {
    ...
    "/greenfield.virtualgroup.MsgReserveSwapIn": {
        aminoType: string;
        toAmino: (message: import("./virtualgroup/tx").MsgReserveSwapIn) => import("./virtualgroup/tx").MsgReserveSwapInAmino;
        fromAmino: (object: import("./virtualgroup/tx").MsgReserveSwapInAmino) => import("./virtualgroup/tx").MsgReserveSwapIn;
    };
    "/greenfield.virtualgroup.MsgCancelSwapIn": {
        aminoType: string;
        toAmino: (message: import("./virtualgroup/tx").MsgCancelSwapIn) => import("./virtualgroup/tx").MsgCancelSwapInAmino;
        fromAmino: (object: import("./virtualgroup/tx").MsgCancelSwapInAmino) => import("./virtualgroup/tx").MsgCancelSwapIn;
    };
    "/greenfield.virtualgroup.MsgCompleteSwapIn": {
        aminoType: string;
        toAmino: (message: import("./virtualgroup/tx").MsgCompleteSwapIn) => import("./virtualgroup/tx").MsgCompleteSwapInAmino;
        fromAmino: (object: import("./virtualgroup/tx").MsgCompleteSwapInAmino) => import("./virtualgroup/tx").MsgCompleteSwapIn;
    };
    "/greenfield.virtualgroup.MsgStorageProviderForcedExit": {
        aminoType: string;
        toAmino: (message: import("./virtualgroup/tx").MsgStorageProviderForcedExit) => import("./virtualgroup/tx").MsgStorageProviderForcedExitAmino;
        fromAmino: (object: import("./virtualgroup/tx").MsgStorageProviderForcedExitAmino) => import("./virtualgroup/tx").MsgStorageProviderForcedExit;
    };
    ...
    "/greenfield.storage.MsgToggleSPAsDelegatedAgent": {
        aminoType: string;
        toAmino: (message: import("./storage/tx").MsgToggleSPAsDelegatedAgent) => import("./storage/tx").MsgToggleSPAsDelegatedAgentAmino;
        fromAmino: (object: import("./storage/tx").MsgToggleSPAsDelegatedAgentAmino) => import("./storage/tx").MsgToggleSPAsDelegatedAgent;
    };
    ...
    "/greenfield.storage.MsgSealObjectV2": {
        aminoType: string;
        toAmino: (message: import("./storage/tx").MsgSealObjectV2) => import("./storage/tx").MsgSealObjectV2Amino;
        fromAmino: (object: import("./storage/tx").MsgSealObjectV2Amino) => import("./storage/tx").MsgSealObjectV2;
    };
    ...
    "/greenfield.storage.MsgUpdateObjectContent": {
        aminoType: string;
        toAmino: (message: import("./storage/tx").MsgUpdateObjectContent) => import("./storage/tx").MsgUpdateObjectContentAmino;
        fromAmino: (object: import("./storage/tx").MsgUpdateObjectContentAmino) => import("./storage/tx").MsgUpdateObjectContent;
    };
    "/greenfield.storage.MsgCancelUpdateObjectContent": {
        aminoType: string;
        toAmino: (message: import("./storage/tx").MsgCancelUpdateObjectContent) => import("./storage/tx").MsgCancelUpdateObjectContentAmino;
        fromAmino: (object: import("./storage/tx").MsgCancelUpdateObjectContentAmino) => import("./storage/tx").MsgCancelUpdateObjectContent;
    };
    "/greenfield.storage.MsgDelegateCreateObject": {
        aminoType: string;
        toAmino: (message: import("./storage/tx").MsgDelegateCreateObject) => import("./storage/tx").MsgDelegateCreateObjectAmino;
        fromAmino: (object: import("./storage/tx").MsgDelegateCreateObjectAmino) => import("./storage/tx").MsgDelegateCreateObject;
    };
    "/greenfield.storage.MsgDelegateUpdateObjectContent": {
        aminoType: string;
        toAmino: (message: import("./storage/tx").MsgDelegateUpdateObjectContent) => import("./storage/tx").MsgDelegateUpdateObjectContentAmino;
        fromAmino: (object: import("./storage/tx").MsgDelegateUpdateObjectContentAmino) => import("./storage/tx").MsgDelegateUpdateObjectContent;
    };
    ...
    "/greenfield.storage.MsgSetBucketFlowRateLimit": {
        aminoType: string;
        toAmino: (message: import("./storage/tx").MsgSetBucketFlowRateLimit) => import("./storage/tx").MsgSetBucketFlowRateLimitAmino;
        fromAmino: (object: import("./storage/tx").MsgSetBucketFlowRateLimitAmino) => import("./storage/tx").MsgSetBucketFlowRateLimit;
    };
