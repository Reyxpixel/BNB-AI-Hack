...
exports.MaintenanceRecord = exports.SpMaintenanceStats = exports.GlobalSpStorePrice = exports.SpStoragePrice = exports.RewardInfo = exports.StorageProvider = exports.Description = exports.statusToJSON = exports.statusFromJSON = exports.StatusAmino = exports.StatusSDKType = exports.Status = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
(function (Status) {
    ...
    Status[Status["STATUS_FORCED_EXITING"] = 4] = "STATUS_FORCED_EXITING";
...
exports.StorageProvider = {
    ...
    fromAminoMsg(object) {
        return exports.StorageProvider.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.StorageProvider.decode(message.value);
    },
    toProto(message) {
        return exports.StorageProvider.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.sp.StorageProvider",
            value: exports.StorageProvider.encode(message).finish()
        };
    }
};
...
exports.RewardInfo = {
    ...
    fromAminoMsg(object) {
        return exports.RewardInfo.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.RewardInfo.decode(message.value);
    },
    toProto(message) {
        return exports.RewardInfo.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.sp.RewardInfo",
            value: exports.RewardInfo.encode(message).finish()
        };
    }
};
...
exports.SpStoragePrice = {
    ...
    fromAminoMsg(object) {
        return exports.SpStoragePrice.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.SpStoragePrice.decode(message.value);
    },
    toProto(message) {
        return exports.SpStoragePrice.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.sp.SpStoragePrice",
            value: exports.SpStoragePrice.encode(message).finish()
        };
    }
};
...
exports.GlobalSpStorePrice = {
    ...
    fromAminoMsg(object) {
        return exports.GlobalSpStorePrice.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.GlobalSpStorePrice.decode(message.value);
    },
    toProto(message) {
        return exports.GlobalSpStorePrice.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.sp.GlobalSpStorePrice",
            value: exports.GlobalSpStorePrice.encode(message).finish()
        };
    }
};
...
exports.SpMaintenanceStats = {
    ...
    fromAmino(object) {
        const message = createBaseSpMaintenanceStats();
        message.records = object.records?.map(e => exports.MaintenanceRecord.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        if (message.records) {
            obj.records = message.records.map(e => e ? exports.MaintenanceRecord.toAmino(e) : undefined);
        }
        else {
            obj.records = [];
        }
    ...
    fromAminoMsg(object) {
        return exports.SpMaintenanceStats.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.SpMaintenanceStats.decode(message.value);
    },
    toProto(message) {
        return exports.SpMaintenanceStats.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.sp.SpMaintenanceStats",
            value: exports.SpMaintenanceStats.encode(message).finish()
        };
    }
};
...
exports.MaintenanceRecord = {
    ...
    fromAmino(object) {
        ...
        if (object.request_duration !== undefined && object.request_duration !== null) {
            message.requestDuration = helpers_1.Long.fromString(object.request_duration);
        }
        if (object.actual_duration !== undefined && object.actual_duration !== null) {
            message.actualDuration = helpers_1.Long.fromString(object.actual_duration);
        }
        if (object.request_at !== undefined && object.request_at !== null) {
            message.requestAt = helpers_1.Long.fromString(object.request_at);
        }
        return message;
    },
    toAmino(message) {
    ...
    fromAminoMsg(object) {
        return exports.MaintenanceRecord.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.MaintenanceRecord.decode(message.value);
    },
    toProto(message) {
        return exports.MaintenanceRecord.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.sp.MaintenanceRecord",
            value: exports.MaintenanceRecord.encode(message).finish()
        };
    }
};
