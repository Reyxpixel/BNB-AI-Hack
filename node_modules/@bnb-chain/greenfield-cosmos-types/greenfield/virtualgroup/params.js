...
exports.Params = {
    ...
    fromJSON(object) {
        return {
            ...
            swapInValidityPeriod: (0, helpers_1.isSet)(object.swapInValidityPeriod) ? String(object.swapInValidityPeriod) : "",
            spConcurrentExitNum: (0, helpers_1.isSet)(object.spConcurrentExitNum) ? String(object.spConcurrentExitNum) : ""
        };
    },
    toJSON(message) {
        const obj = {};
