...
import { PickVGFStrategy } from "./common";
...
export declare const QuerySwapInInfoRequest: {
    typeUrl: string;
    encode(message: QuerySwapInInfoRequest, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends {
        ...
        globalVirtualGroupFamilyId?: number;
        globalVirtualGroupId?: number;
    } & Record<Exclude<keyof I, keyof QuerySwapInInfoRequest>, never>>(object: I): QuerySwapInInfoRequest;
...
export declare const QuerySwapInInfoResponse: {
    typeUrl: string;
    encode(message: QuerySwapInInfoResponse, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends {
        swapInInfo?: {
            ...
            targetSpId?: number;
            expirationTime?: string | number | import("long").Long;
        };
    } & {
        swapInInfo?: {
            successorSpId?: number;
            ...
            expirationTime?: string | number | (import("long").Long & {
                ...
                toUnsigned: () => import("long").Long;
                xor: (other: string | number | import("long").Long) => import("long").Long;
            } & Record<Exclude<keyof I["swapInInfo"]["expirationTime"], keyof import("long").Long>, never>);
        } & Record<Exclude<keyof I["swapInInfo"], keyof SwapInInfo>, never>;
    } & Record<Exclude<keyof I, "swapInInfo">, never>>(object: I): QuerySwapInInfoResponse;
...
export declare const QuerySPGVGStatisticsRequest: {
    typeUrl: string;
    encode(message: QuerySPGVGStatisticsRequest, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends {
        ...
        spId?: number;
    } & Record<Exclude<keyof I, "spId">, never>>(object: I): QuerySPGVGStatisticsRequest;
...
export declare const QuerySPGVGStatisticsResponse: {
    typeUrl: string;
    encode(message: QuerySPGVGStatisticsResponse, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends {
        ...
        gvgStats?: {
            ...
            secondaryCount?: number;
            breakRedundancyReqmtGvgCount?: number;
        } & Record<Exclude<keyof I["gvgStats"], keyof GVGStatisticsWithinSP>, never>;
    } & Record<Exclude<keyof I, "gvgStats">, never>>(object: I): QuerySPGVGStatisticsResponse;
...
export declare const QuerySPAvailableGlobalVirtualGroupFamiliesRequest: {
    typeUrl: string;
    encode(message: QuerySPAvailableGlobalVirtualGroupFamiliesRequest, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends {
        ...
        spId?: number;
    } & Record<Exclude<keyof I, "spId">, never>>(object: I): QuerySPAvailableGlobalVirtualGroupFamiliesRequest;
...
export declare const QuerySPAvailableGlobalVirtualGroupFamiliesResponse: {
    typeUrl: string;
    encode(message: QuerySPAvailableGlobalVirtualGroupFamiliesResponse, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends {
        ...
        globalVirtualGroupFamilyIds?: number[] & number[] & Record<Exclude<keyof I["globalVirtualGroupFamilyIds"], keyof number[]>, never>;
    } & Record<Exclude<keyof I, "globalVirtualGroupFamilyIds">, never>>(object: I): QuerySPAvailableGlobalVirtualGroupFamiliesResponse;
...
export declare const QuerySpOptimalGlobalVirtualGroupFamilyRequest: {
    typeUrl: string;
    encode(message: QuerySpOptimalGlobalVirtualGroupFamilyRequest, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends {
        ...
        spId?: number;
        pickVgfStrategy?: PickVGFStrategy;
    } & Record<Exclude<keyof I, keyof QuerySpOptimalGlobalVirtualGroupFamilyRequest>, never>>(object: I): QuerySpOptimalGlobalVirtualGroupFamilyRequest;
...
export declare const QuerySpOptimalGlobalVirtualGroupFamilyResponse: {
    typeUrl: string;
    encode(message: QuerySpOptimalGlobalVirtualGroupFamilyResponse, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends {
        ...
        globalVirtualGroupFamilyId?: number;
    } & Record<Exclude<keyof I, "globalVirtualGroupFamilyId">, never>>(object: I): QuerySpOptimalGlobalVirtualGroupFamilyResponse;
