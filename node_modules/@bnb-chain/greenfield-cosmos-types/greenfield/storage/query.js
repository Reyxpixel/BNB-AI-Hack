...
exports.QueryParamsByTimestampRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryParamsByTimestampRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryParamsByTimestampRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryParamsByTimestampRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryParamsByTimestampRequest",
            value: exports.QueryParamsByTimestampRequest.encode(message).finish()
        };
    }
};
...
exports.QueryParamsByTimestampResponse = {
    ...
    fromAminoMsg(object) {
        return exports.QueryParamsByTimestampResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryParamsByTimestampResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryParamsByTimestampResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryParamsByTimestampResponse",
            value: exports.QueryParamsByTimestampResponse.encode(message).finish()
        };
    }
};
...
exports.QueryHeadBucketRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryHeadBucketRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadBucketRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadBucketRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadBucketRequest",
            value: exports.QueryHeadBucketRequest.encode(message).finish()
        };
    }
};
...
exports.QueryHeadBucketByIdRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryHeadBucketByIdRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadBucketByIdRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadBucketByIdRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadBucketByIdRequest",
            value: exports.QueryHeadBucketByIdRequest.encode(message).finish()
        };
    }
};
...
exports.QueryHeadBucketResponse = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.extraInfo !== undefined) {
            types_1.BucketExtraInfo.encode(message.extraInfo, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.extraInfo = types_1.BucketExtraInfo.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            ...
            extraInfo: (0, helpers_1.isSet)(object.extraInfo) ? types_1.BucketExtraInfo.fromJSON(object.extraInfo) : undefined
        };
    },
    toJSON(message) {
        const obj = {};
        message.bucketInfo !== undefined && (obj.bucketInfo = message.bucketInfo ? types_1.BucketInfo.toJSON(message.bucketInfo) : undefined);
        message.extraInfo !== undefined && (obj.extraInfo = message.extraInfo ? types_1.BucketExtraInfo.toJSON(message.extraInfo) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryHeadBucketResponse();
        ...
        message.extraInfo = object.extraInfo !== undefined && object.extraInfo !== null ? types_1.BucketExtraInfo.fromPartial(object.extraInfo) : undefined;
        return message;
    },
    fromSDK(object) {
        return {
            bucketInfo: object.bucket_info ? types_1.BucketInfo.fromSDK(object.bucket_info) : undefined,
            extraInfo: object.extra_info ? types_1.BucketExtraInfo.fromSDK(object.extra_info) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        message.bucketInfo !== undefined && (obj.bucket_info = message.bucketInfo ? types_1.BucketInfo.toSDK(message.bucketInfo) : undefined);
        message.extraInfo !== undefined && (obj.extra_info = message.extraInfo ? types_1.BucketExtraInfo.toSDK(message.extraInfo) : undefined);
        return obj;
    },
    fromAmino(object) {
        const message = createBaseQueryHeadBucketResponse();
        if (object.bucket_info !== undefined && object.bucket_info !== null) {
            message.bucketInfo = types_1.BucketInfo.fromAmino(object.bucket_info);
        }
        if (object.extra_info !== undefined && object.extra_info !== null) {
            message.extraInfo = types_1.BucketExtraInfo.fromAmino(object.extra_info);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.bucket_info = message.bucketInfo ? types_1.BucketInfo.toAmino(message.bucketInfo) : undefined;
        obj.extra_info = message.extraInfo ? types_1.BucketExtraInfo.toAmino(message.extraInfo) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryHeadBucketResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadBucketResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadBucketResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadBucketResponse",
            value: exports.QueryHeadBucketResponse.encode(message).finish()
        };
    }
};
...
exports.QueryHeadObjectRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryHeadObjectRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadObjectRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadObjectRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadObjectRequest",
            value: exports.QueryHeadObjectRequest.encode(message).finish()
        };
    }
};
...
exports.QueryHeadObjectByIdRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryHeadObjectByIdRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadObjectByIdRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadObjectByIdRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadObjectByIdRequest",
            value: exports.QueryHeadObjectByIdRequest.encode(message).finish()
        };
    }
};
function createBaseQueryHeadShadowObjectRequest() {
    return {
        bucketName: "",
        objectName: ""
    };
}
exports.QueryHeadShadowObjectRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryHeadShadowObjectRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadShadowObjectRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadShadowObjectRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadShadowObjectRequest",
            value: exports.QueryHeadShadowObjectRequest.encode(message).finish()
        };
    }
};
...
exports.QueryHeadObjectResponse = {
    ...
    fromAmino(object) {
        ...
        if (object.object_info !== undefined && object.object_info !== null) {
            message.objectInfo = types_1.ObjectInfo.fromAmino(object.object_info);
        }
        if (object.global_virtual_group !== undefined && object.global_virtual_group !== null) {
            message.globalVirtualGroup = types_2.GlobalVirtualGroup.fromAmino(object.global_virtual_group);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.object_info = message.objectInfo ? types_1.ObjectInfo.toAmino(message.objectInfo) : undefined;
        obj.global_virtual_group = message.globalVirtualGroup ? types_2.GlobalVirtualGroup.toAmino(message.globalVirtualGroup) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryHeadObjectResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadObjectResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadObjectResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadObjectResponse",
            value: exports.QueryHeadObjectResponse.encode(message).finish()
        };
    }
};
function createBaseQueryHeadShadowObjectResponse() {
    return {
        objectInfo: undefined
    };
}
exports.QueryHeadShadowObjectResponse = {
    typeUrl: "/greenfield.storage.QueryHeadShadowObjectResponse",
    encode(message, writer = _m0.Writer.create()) {
        if (message.objectInfo !== undefined) {
            types_1.ShadowObjectInfo.encode(message.objectInfo, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.objectInfo = types_1.ShadowObjectInfo.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            objectInfo: (0, helpers_1.isSet)(object.objectInfo) ? types_1.ShadowObjectInfo.fromJSON(object.objectInfo) : undefined
        };
    },
    toJSON(message) {
        const obj = {};
        message.objectInfo !== undefined && (obj.objectInfo = message.objectInfo ? types_1.ShadowObjectInfo.toJSON(message.objectInfo) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryHeadShadowObjectResponse();
        message.objectInfo = object.objectInfo !== undefined && object.objectInfo !== null ? types_1.ShadowObjectInfo.fromPartial(object.objectInfo) : undefined;
        return message;
    },
    fromSDK(object) {
        return {
            objectInfo: object.object_info ? types_1.ShadowObjectInfo.fromSDK(object.object_info) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        message.objectInfo !== undefined && (obj.object_info = message.objectInfo ? types_1.ShadowObjectInfo.toSDK(message.objectInfo) : undefined);
        return obj;
    },
    fromAmino(object) {
        const message = createBaseQueryHeadShadowObjectResponse();
        if (object.object_info !== undefined && object.object_info !== null) {
            message.objectInfo = types_1.ShadowObjectInfo.fromAmino(object.object_info);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.object_info = message.objectInfo ? types_1.ShadowObjectInfo.toAmino(message.objectInfo) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryHeadShadowObjectResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadShadowObjectResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadShadowObjectResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadShadowObjectResponse",
            value: exports.QueryHeadShadowObjectResponse.encode(message).finish()
        };
    }
};
...
exports.QueryListBucketsRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryListBucketsRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryListBucketsRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryListBucketsRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryListBucketsRequest",
            value: exports.QueryListBucketsRequest.encode(message).finish()
        };
    }
};
...
exports.QueryListBucketsResponse = {
    ...
    fromAmino(object) {
        const message = createBaseQueryListBucketsResponse();
        message.bucketInfos = object.bucket_infos?.map(e => types_1.BucketInfo.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
    ...
    toAmino(message) {
        const obj = {};
        if (message.bucketInfos) {
            obj.bucket_infos = message.bucketInfos.map(e => e ? types_1.BucketInfo.toAmino(e) : undefined);
        }
        else {
            obj.bucket_infos = [];
        }
    ...
    fromAminoMsg(object) {
        return exports.QueryListBucketsResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryListBucketsResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryListBucketsResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryListBucketsResponse",
            value: exports.QueryListBucketsResponse.encode(message).finish()
        };
    }
};
...
exports.QueryListObjectsRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryListObjectsRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryListObjectsRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryListObjectsRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryListObjectsRequest",
            value: exports.QueryListObjectsRequest.encode(message).finish()
        };
    }
};
...
exports.QueryListObjectsByBucketIdRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryListObjectsByBucketIdRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryListObjectsByBucketIdRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryListObjectsByBucketIdRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryListObjectsByBucketIdRequest",
            value: exports.QueryListObjectsByBucketIdRequest.encode(message).finish()
        };
    }
};
...
exports.QueryListObjectsResponse = {
    ...
    fromAmino(object) {
        const message = createBaseQueryListObjectsResponse();
        message.objectInfos = object.object_infos?.map(e => types_1.ObjectInfo.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_1.PageResponse.fromAmino(object.pagination);
        }
        return message;
    ...
    toAmino(message) {
        const obj = {};
        if (message.objectInfos) {
            obj.object_infos = message.objectInfos.map(e => e ? types_1.ObjectInfo.toAmino(e) : undefined);
        }
        else {
            obj.object_infos = [];
        }
    ...
    fromAminoMsg(object) {
        return exports.QueryListObjectsResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryListObjectsResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryListObjectsResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryListObjectsResponse",
            value: exports.QueryListObjectsResponse.encode(message).finish()
        };
    }
};
...
exports.QueryBucketNFTResponse = {
    ...
    fromAmino(object) {
        ...
        if (object.meta_data !== undefined && object.meta_data !== null) {
            message.metaData = types_1.BucketMetaData.fromAmino(object.meta_data);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.meta_data = message.metaData ? types_1.BucketMetaData.toAmino(message.metaData) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryBucketNFTResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryBucketNFTResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryBucketNFTResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryBucketNFTResponse",
            value: exports.QueryBucketNFTResponse.encode(message).finish()
        };
    }
};
...
exports.QueryObjectNFTResponse = {
    ...
    fromAmino(object) {
        const message = createBaseQueryObjectNFTResponse();
        if (object.meta_data !== undefined && object.meta_data !== null) {
            message.metaData = types_1.ObjectMetaData.fromAmino(object.meta_data);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.meta_data = message.metaData ? types_1.ObjectMetaData.toAmino(message.metaData) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryObjectNFTResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryObjectNFTResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryObjectNFTResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryObjectNFTResponse",
            value: exports.QueryObjectNFTResponse.encode(message).finish()
        };
    }
};
...
exports.QueryGroupNFTResponse = {
    ...
    fromAmino(object) {
        const message = createBaseQueryGroupNFTResponse();
        if (object.meta_data !== undefined && object.meta_data !== null) {
            message.metaData = types_1.GroupMetaData.fromAmino(object.meta_data);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.meta_data = message.metaData ? types_1.GroupMetaData.toAmino(message.metaData) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryGroupNFTResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryGroupNFTResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryGroupNFTResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryGroupNFTResponse",
            value: exports.QueryGroupNFTResponse.encode(message).finish()
        };
    }
};
...
exports.QueryPolicyForAccountRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryPolicyForAccountRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryPolicyForAccountRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryPolicyForAccountRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryPolicyForAccountRequest",
            value: exports.QueryPolicyForAccountRequest.encode(message).finish()
        };
    }
};
...
exports.QueryPolicyForAccountResponse = {
    ...
    fromAmino(object) {
        ...
        if (object.policy !== undefined && object.policy !== null) {
            message.policy = types_3.Policy.fromAmino(object.policy);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.policy = message.policy ? types_3.Policy.toAmino(message.policy) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryPolicyForAccountResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryPolicyForAccountResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryPolicyForAccountResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryPolicyForAccountResponse",
            value: exports.QueryPolicyForAccountResponse.encode(message).finish()
        };
    }
};
...
exports.QueryVerifyPermissionRequest = {
    ...
    fromAmino(object) {
        ...
        if (object.action_type !== undefined && object.action_type !== null) {
            message.actionType = (0, common_1.actionTypeFromJSON)(object.action_type);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.bucket_name = message.bucketName;
        obj.object_name = message.objectName;
        obj.action_type = (0, common_1.actionTypeToJSON)(message.actionType);
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryVerifyPermissionRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryVerifyPermissionRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryVerifyPermissionRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryVerifyPermissionRequest",
            value: exports.QueryVerifyPermissionRequest.encode(message).finish()
        };
    }
};
...
exports.QueryVerifyPermissionResponse = {
    ...
    fromAmino(object) {
        ...
        if (object.effect !== undefined && object.effect !== null) {
            message.effect = (0, common_1.effectFromJSON)(object.effect);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.effect = (0, common_1.effectToJSON)(message.effect);
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryVerifyPermissionResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryVerifyPermissionResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryVerifyPermissionResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryVerifyPermissionResponse",
            value: exports.QueryVerifyPermissionResponse.encode(message).finish()
        };
    }
};
...
exports.QueryHeadGroupRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryHeadGroupRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadGroupRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadGroupRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadGroupRequest",
            value: exports.QueryHeadGroupRequest.encode(message).finish()
        };
    }
};
...
exports.QueryHeadGroupResponse = {
    ...
    fromAmino(object) {
        ...
        if (object.group_info !== undefined && object.group_info !== null) {
            message.groupInfo = types_1.GroupInfo.fromAmino(object.group_info);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.group_info = message.groupInfo ? types_1.GroupInfo.toAmino(message.groupInfo) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryHeadGroupResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadGroupResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadGroupResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadGroupResponse",
            value: exports.QueryHeadGroupResponse.encode(message).finish()
        };
    }
};
...
exports.QueryListGroupsRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryListGroupsRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryListGroupsRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryListGroupsRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryListGroupsRequest",
            value: exports.QueryListGroupsRequest.encode(message).finish()
        };
    }
};
...
exports.QueryListGroupsResponse = {
    ...
    fromAmino(object) {
        ...
        message.groupInfos = object.group_infos?.map(e => types_1.GroupInfo.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.pagination = message.pagination ? pagination_1.PageResponse.toAmino(message.pagination) : undefined;
        if (message.groupInfos) {
            obj.group_infos = message.groupInfos.map(e => e ? types_1.GroupInfo.toAmino(e) : undefined);
        }
        else {
            obj.group_infos = [];
        }
    ...
    fromAminoMsg(object) {
        return exports.QueryListGroupsResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryListGroupsResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryListGroupsResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryListGroupsResponse",
            value: exports.QueryListGroupsResponse.encode(message).finish()
        };
    }
};
...
exports.QueryHeadGroupMemberRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryHeadGroupMemberRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadGroupMemberRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadGroupMemberRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadGroupMemberRequest",
            value: exports.QueryHeadGroupMemberRequest.encode(message).finish()
        };
    }
};
...
exports.QueryHeadGroupMemberResponse = {
    ...
    fromAmino(object) {
        ...
        if (object.group_member !== undefined && object.group_member !== null) {
            message.groupMember = types_3.GroupMember.fromAmino(object.group_member);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.group_member = message.groupMember ? types_3.GroupMember.toAmino(message.groupMember) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryHeadGroupMemberResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadGroupMemberResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadGroupMemberResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadGroupMemberResponse",
            value: exports.QueryHeadGroupMemberResponse.encode(message).finish()
        };
    }
};
...
exports.QueryPolicyForGroupRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryPolicyForGroupRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryPolicyForGroupRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryPolicyForGroupRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryPolicyForGroupRequest",
            value: exports.QueryPolicyForGroupRequest.encode(message).finish()
        };
    }
};
...
exports.QueryPolicyForGroupResponse = {
    ...
    fromAminoMsg(object) {
        return exports.QueryPolicyForGroupResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryPolicyForGroupResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryPolicyForGroupResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryPolicyForGroupResponse",
            value: exports.QueryPolicyForGroupResponse.encode(message).finish()
        };
    }
};
...
exports.QueryPolicyByIdRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryPolicyByIdRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryPolicyByIdRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryPolicyByIdRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryPolicyByIdRequest",
            value: exports.QueryPolicyByIdRequest.encode(message).finish()
        };
    }
};
...
exports.QueryPolicyByIdResponse = {
    ...
    fromAminoMsg(object) {
        return exports.QueryPolicyByIdResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryPolicyByIdResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryPolicyByIdResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryPolicyByIdResponse",
            value: exports.QueryPolicyByIdResponse.encode(message).finish()
        };
    }
};
...
exports.QueryLockFeeRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryLockFeeRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryLockFeeRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryLockFeeRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryLockFeeRequest",
            value: exports.QueryLockFeeRequest.encode(message).finish()
        };
    }
};
...
exports.QueryLockFeeResponse = {
    ...
    fromAminoMsg(object) {
        return exports.QueryLockFeeResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryLockFeeResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryLockFeeResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryLockFeeResponse",
            value: exports.QueryLockFeeResponse.encode(message).finish()
        };
    }
};
...
exports.QueryHeadBucketExtraRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryHeadBucketExtraRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadBucketExtraRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadBucketExtraRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadBucketExtraRequest",
            value: exports.QueryHeadBucketExtraRequest.encode(message).finish()
        };
    }
};
...
exports.QueryHeadBucketExtraResponse = {
    ...
    fromAmino(object) {
        const message = createBaseQueryHeadBucketExtraResponse();
        if (object.extra_info !== undefined && object.extra_info !== null) {
            message.extraInfo = types_1.InternalBucketInfo.fromAmino(object.extra_info);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.extra_info = message.extraInfo ? types_1.InternalBucketInfo.toAmino(message.extraInfo) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.QueryHeadBucketExtraResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryHeadBucketExtraResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryHeadBucketExtraResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryHeadBucketExtraResponse",
            value: exports.QueryHeadBucketExtraResponse.encode(message).finish()
        };
    }
};
...
exports.QueryIsPriceChangedRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryIsPriceChangedRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryIsPriceChangedRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryIsPriceChangedRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryIsPriceChangedRequest",
            value: exports.QueryIsPriceChangedRequest.encode(message).finish()
        };
    }
};
...
exports.QueryIsPriceChangedResponse = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.currentReadPrice !== "") {
            writer.uint32(18).string(math_1.Decimal.fromUserInput(message.currentReadPrice, 18).atomics);
        }
        if (message.currentPrimaryStorePrice !== "") {
            writer.uint32(26).string(math_1.Decimal.fromUserInput(message.currentPrimaryStorePrice, 18).atomics);
        }
        if (message.currentSecondaryStorePrice !== "") {
            writer.uint32(34).string(math_1.Decimal.fromUserInput(message.currentSecondaryStorePrice, 18).atomics);
        }
        if (message.currentValidatorTaxRate !== "") {
            writer.uint32(42).string(math_1.Decimal.fromUserInput(message.currentValidatorTaxRate, 18).atomics);
        }
        if (message.newReadPrice !== "") {
            writer.uint32(50).string(math_1.Decimal.fromUserInput(message.newReadPrice, 18).atomics);
        }
        if (message.newPrimaryStorePrice !== "") {
            writer.uint32(58).string(math_1.Decimal.fromUserInput(message.newPrimaryStorePrice, 18).atomics);
        }
        if (message.newSecondaryStorePrice !== "") {
            writer.uint32(66).string(math_1.Decimal.fromUserInput(message.newSecondaryStorePrice, 18).atomics);
        }
        if (message.newValidatorTaxRate !== "") {
            writer.uint32(74).string(math_1.Decimal.fromUserInput(message.newValidatorTaxRate, 18).atomics);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.currentReadPrice = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 3:
                    message.currentPrimaryStorePrice = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 4:
                    message.currentSecondaryStorePrice = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 5:
                    message.currentValidatorTaxRate = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 6:
                    message.newReadPrice = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 7:
                    message.newPrimaryStorePrice = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 8:
                    message.newSecondaryStorePrice = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                case 9:
                    message.newValidatorTaxRate = math_1.Decimal.fromAtomics(reader.string(), 18).toString();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromAminoMsg(object) {
        return exports.QueryIsPriceChangedResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryIsPriceChangedResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryIsPriceChangedResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryIsPriceChangedResponse",
            value: exports.QueryIsPriceChangedResponse.encode(message).finish()
        };
    }
};
...
exports.QueryQuoteUpdateTimeRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryQuoteUpdateTimeRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryQuoteUpdateTimeRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryQuoteUpdateTimeRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryQuoteUpdateTimeRequest",
            value: exports.QueryQuoteUpdateTimeRequest.encode(message).finish()
        };
    }
};
...
exports.QueryQuoteUpdateTimeResponse = {
    ...
    fromAmino(object) {
        ...
        if (object.update_at !== undefined && object.update_at !== null) {
            message.updateAt = helpers_1.Long.fromString(object.update_at);
        }
        return message;
    },
    toAmino(message) {
    ...
    fromAminoMsg(object) {
        return exports.QueryQuoteUpdateTimeResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryQuoteUpdateTimeResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryQuoteUpdateTimeResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryQuoteUpdateTimeResponse",
            value: exports.QueryQuoteUpdateTimeResponse.encode(message).finish()
        };
    }
};
...
exports.QueryGroupMembersExistRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryGroupMembersExistRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryGroupMembersExistRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryGroupMembersExistRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryGroupMembersExistRequest",
            value: exports.QueryGroupMembersExistRequest.encode(message).finish()
        };
    }
};
...
exports.QueryGroupMembersExistResponse_ExistsEntry = {
    ...
    fromAminoMsg(object) {
        return exports.QueryGroupMembersExistResponse_ExistsEntry.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryGroupMembersExistResponse_ExistsEntry.decode(message.value);
    },
    toProto(message) {
        return exports.QueryGroupMembersExistResponse_ExistsEntry.encode(message).finish();
    }
};
...
exports.QueryGroupMembersExistResponse = {
    ...
    fromAminoMsg(object) {
        return exports.QueryGroupMembersExistResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryGroupMembersExistResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryGroupMembersExistResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryGroupMembersExistResponse",
            value: exports.QueryGroupMembersExistResponse.encode(message).finish()
        };
    }
};
...
exports.QueryGroupsExistRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryGroupsExistRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryGroupsExistRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryGroupsExistRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryGroupsExistRequest",
            value: exports.QueryGroupsExistRequest.encode(message).finish()
        };
    }
};
...
exports.QueryGroupsExistByIdRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryGroupsExistByIdRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryGroupsExistByIdRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryGroupsExistByIdRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryGroupsExistByIdRequest",
            value: exports.QueryGroupsExistByIdRequest.encode(message).finish()
        };
    }
};
...
exports.QueryGroupsExistResponse_ExistsEntry = {
    ...
    fromAminoMsg(object) {
        return exports.QueryGroupsExistResponse_ExistsEntry.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryGroupsExistResponse_ExistsEntry.decode(message.value);
    },
    toProto(message) {
        return exports.QueryGroupsExistResponse_ExistsEntry.encode(message).finish();
    }
};
...
exports.QueryGroupsExistResponse = {
    ...
    fromAminoMsg(object) {
        return exports.QueryGroupsExistResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryGroupsExistResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryGroupsExistResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryGroupsExistResponse",
            value: exports.QueryGroupsExistResponse.encode(message).finish()
        };
    }
};
function createBaseQueryPaymentAccountBucketFlowRateLimitRequest() {
    return {
        paymentAccount: "",
        bucketOwner: "",
        bucketName: ""
...
exports.QueryPaymentAccountBucketFlowRateLimitRequest = {
    typeUrl: "/greenfield.storage.QueryPaymentAccountBucketFlowRateLimitRequest",
    encode(message, writer = _m0.Writer.create()) {
        if (message.paymentAccount !== "") {
            writer.uint32(10).string(message.paymentAccount);
        }
        if (message.bucketOwner !== "") {
            writer.uint32(18).string(message.bucketOwner);
        }
        if (message.bucketName !== "") {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseQueryPaymentAccountBucketFlowRateLimitRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return {
            paymentAccount: (0, helpers_1.isSet)(object.paymentAccount) ? String(object.paymentAccount) : "",
    ...
    toJSON(message) {
        const obj = {};
        message.paymentAccount !== undefined && (obj.paymentAccount = message.paymentAccount);
    ...
    fromSDK(object) {
        return {
            paymentAccount: object?.payment_account,
    ...
    toSDK(message) {
        const obj = {};
        obj.payment_account = message.paymentAccount;
    ...
    fromAmino(object) {
        ...
        if (object.payment_account !== undefined && object.payment_account !== null) {
            message.paymentAccount = object.payment_account;
        }
    ...
    fromAminoMsg(object) {
        return exports.QueryPaymentAccountBucketFlowRateLimitRequest.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryPaymentAccountBucketFlowRateLimitRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryPaymentAccountBucketFlowRateLimitRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryPaymentAccountBucketFlowRateLimitRequest",
            value: exports.QueryPaymentAccountBucketFlowRateLimitRequest.encode(message).finish()
        };
    }
};
function createBaseQueryPaymentAccountBucketFlowRateLimitResponse() {
    return {
        isSet: false,
        flowRateLimit: ""
    };
}
exports.QueryPaymentAccountBucketFlowRateLimitResponse = {
    typeUrl: "/greenfield.storage.QueryPaymentAccountBucketFlowRateLimitResponse",
    encode(message, writer = _m0.Writer.create()) {
        if (message.isSet === true) {
            writer.uint32(8).bool(message.isSet);
        }
        if (message.flowRateLimit !== "") {
            writer.uint32(18).string(message.flowRateLimit);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseQueryPaymentAccountBucketFlowRateLimitResponse();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return {
            isSet: (0, helpers_1.isSet)(object.isSet) ? Boolean(object.isSet) : false,
    ...
    toSDK(message) {
        const obj = {};
        obj.is_set = message.isSet;
        obj.flow_rate_limit = message.flowRateLimit;
        return obj;
    },
    fromAmino(object) {
        const message = createBaseQueryPaymentAccountBucketFlowRateLimitResponse();
        if (object.is_set !== undefined && object.is_set !== null) {
            message.isSet = object.is_set;
        }
    ...
    fromAminoMsg(object) {
        return exports.QueryPaymentAccountBucketFlowRateLimitResponse.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.QueryPaymentAccountBucketFlowRateLimitResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryPaymentAccountBucketFlowRateLimitResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.QueryPaymentAccountBucketFlowRateLimitResponse",
            value: exports.QueryPaymentAccountBucketFlowRateLimitResponse.encode(message).finish()
        };
    }
};
class QueryClientImpl {
    constructor(rpc) {
        ...
        this.QueryPaymentAccountBucketFlowRateLimit = this.QueryPaymentAccountBucketFlowRateLimit.bind(this);
    }
    Params(request = {}) {
    ...
    HeadShadowObject(request) {
        const data = exports.QueryHeadShadowObjectRequest.encode(request).finish();
        const promise = this.rpc.request("greenfield.storage.Query", "HeadShadowObject", data);
        return promise.then(data => exports.QueryHeadShadowObjectResponse.decode(new _m0.Reader(data)));
    }
    ...
    QueryPaymentAccountBucketFlowRateLimit(request) {
        const data = exports.QueryPaymentAccountBucketFlowRateLimitRequest.encode(request).finish();
        const promise = this.rpc.request("greenfield.storage.Query", "QueryPaymentAccountBucketFlowRateLimit", data);
        return promise.then(data => exports.QueryPaymentAccountBucketFlowRateLimitResponse.decode(new _m0.Reader(data)));
    }
}
