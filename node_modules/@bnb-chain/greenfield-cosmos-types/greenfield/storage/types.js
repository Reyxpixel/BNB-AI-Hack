...
exports.BucketExtraInfo = exports.ShadowObjectInfo = exports.ResourceTags_Tag = exports.ResourceTags = exports.MigrationBucketInfo = exports.DeleteInfo = exports.Ids = exports.GroupMetaData = exports.ObjectMetaData = exports.BucketMetaData = exports.Trait = exports.GroupInfo = exports.ObjectInfo = exports.InternalBucketInfo = exports.BucketInfo = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
exports.ObjectInfo = {
    ...
    fromJSON(object) {
        return {
            ...
            tags: (0, helpers_1.isSet)(object.tags) ? exports.ResourceTags.fromJSON(object.tags) : undefined,
            isUpdating: (0, helpers_1.isSet)(object.isUpdating) ? Boolean(object.isUpdating) : false,
            updatedAt: (0, helpers_1.isSet)(object.updatedAt) ? helpers_1.Long.fromValue(object.updatedAt) : helpers_1.Long.ZERO,
            updatedBy: (0, helpers_1.isSet)(object.updatedBy) ? String(object.updatedBy) : "",
...
function createBaseShadowObjectInfo() {
    return {
        operator: "",
        id: "",
        contentType: "",
...
exports.ShadowObjectInfo = {
    ...
    fromAminoMsg(object) {
        return exports.ShadowObjectInfo.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.ShadowObjectInfo.decode(message.value);
    },
    toProto(message) {
        return exports.ShadowObjectInfo.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.ShadowObjectInfo",
            value: exports.ShadowObjectInfo.encode(message).finish()
        };
    }
};
function createBaseBucketExtraInfo() {
    return {
        isRateLimited: false,
        flowRateLimit: "",
        currentFlowRate: ""
...
exports.BucketExtraInfo = {
    typeUrl: "/greenfield.storage.BucketExtraInfo",
    encode(message, writer = _m0.Writer.create()) {
        if (message.isRateLimited === true) {
            writer.uint32(8).bool(message.isRateLimited);
        }
        if (message.flowRateLimit !== "") {
            writer.uint32(18).string(message.flowRateLimit);
        }
        if (message.currentFlowRate !== "") {
            writer.uint32(26).string(message.currentFlowRate);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseBucketExtraInfo();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.isRateLimited = reader.bool();
                    break;
                case 2:
                    message.flowRateLimit = reader.string();
                    break;
                case 3:
                    message.currentFlowRate = reader.string();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            isRateLimited: (0, helpers_1.isSet)(object.isRateLimited) ? Boolean(object.isRateLimited) : false,
            flowRateLimit: (0, helpers_1.isSet)(object.flowRateLimit) ? String(object.flowRateLimit) : "",
            currentFlowRate: (0, helpers_1.isSet)(object.currentFlowRate) ? String(object.currentFlowRate) : ""
        };
    },
    toJSON(message) {
        const obj = {};
        message.isRateLimited !== undefined && (obj.isRateLimited = message.isRateLimited);
        message.flowRateLimit !== undefined && (obj.flowRateLimit = message.flowRateLimit);
        message.currentFlowRate !== undefined && (obj.currentFlowRate = message.currentFlowRate);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseBucketExtraInfo();
        message.isRateLimited = object.isRateLimited ?? false;
        message.flowRateLimit = object.flowRateLimit ?? "";
        message.currentFlowRate = object.currentFlowRate ?? "";
        return message;
    },
    fromSDK(object) {
        return {
            isRateLimited: object?.is_rate_limited,
            flowRateLimit: object?.flow_rate_limit,
            currentFlowRate: object?.current_flow_rate
        };
    },
    toSDK(message) {
        const obj = {};
        obj.is_rate_limited = message.isRateLimited;
        obj.flow_rate_limit = message.flowRateLimit;
        obj.current_flow_rate = message.currentFlowRate;
        return obj;
    },
    fromAmino(object) {
        const message = createBaseBucketExtraInfo();
        if (object.is_rate_limited !== undefined && object.is_rate_limited !== null) {
            message.isRateLimited = object.is_rate_limited;
        }
        ...
        if (object.current_flow_rate !== undefined && object.current_flow_rate !== null) {
            message.currentFlowRate = object.current_flow_rate;
        }
        return message;
    },
    toAmino(message) {
    ...
    fromAminoMsg(object) {
        return exports.BucketExtraInfo.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.BucketExtraInfo.decode(message.value);
    },
    toProto(message) {
        return exports.BucketExtraInfo.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.BucketExtraInfo",
            value: exports.BucketExtraInfo.encode(message).finish()
        };
    }
};
