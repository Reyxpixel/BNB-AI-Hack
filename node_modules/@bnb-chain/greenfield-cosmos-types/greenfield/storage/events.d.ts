...
export interface EventSetBucketFlowRateLimit {
...
export interface EventSetBucketFlowRateLimitProtoMsg {
    typeUrl: "/greenfield.storage.EventSetBucketFlowRateLimit";
    value: Uint8Array;
}
export interface EventSetBucketFlowRateLimitAmino {
    /** operator define the account address of operator who set the bucket flow rate limit */
    operator?: string;
    /** bucket_name define the name of the bucket */
    bucket_name?: string;
...
export interface EventSetBucketFlowRateLimitAminoMsg {
    type: "/greenfield.storage.EventSetBucketFlowRateLimit";
    value: EventSetBucketFlowRateLimitAmino;
}
export interface EventSetBucketFlowRateLimitSDKType {
    operator: string;
    bucket_name: string;
    payment_address: string;
    bucket_owner: string;
...
export interface EventBucketFlowRateLimitStatus {
    /** bucket_name define the name of the bucket */
    bucketName: string;
...
export interface EventBucketFlowRateLimitStatusProtoMsg {
    typeUrl: "/greenfield.storage.EventBucketFlowRateLimitStatus";
    value: Uint8Array;
}
export interface EventBucketFlowRateLimitStatusAmino {
    /** bucket_name define the name of the bucket */
    bucket_name?: string;
    /** is_limited define the status of the bucket flow rate limit */
    is_limited?: boolean;
...
export interface EventBucketFlowRateLimitStatusAminoMsg {
    type: "/greenfield.storage.EventBucketFlowRateLimitStatus";
    value: EventBucketFlowRateLimitStatusAmino;
}
export interface EventBucketFlowRateLimitStatusSDKType {
    bucket_name: string;
    is_limited: boolean;
    bucket_id: string;
}
export interface EventToggleSPAsDelegatedAgent {
    /** bucket_name define the name of the bucket */
    bucketName: string;
    /** bucket_id is the unique u256 for bucket. Not global, only unique in buckets. */
    bucketId: string;
...
export interface EventToggleSPAsDelegatedAgentProtoMsg {
    typeUrl: "/greenfield.storage.EventToggleSPAsDelegatedAgent";
    value: Uint8Array;
}
export interface EventToggleSPAsDelegatedAgentAmino {
    /** bucket_name define the name of the bucket */
    bucket_name?: string;
    /** bucket_id is the unique u256 for bucket. Not global, only unique in buckets. */
    bucket_id?: string;
...
export interface EventToggleSPAsDelegatedAgentAminoMsg {
    type: "/greenfield.storage.EventToggleSPAsDelegatedAgent";
    value: EventToggleSPAsDelegatedAgentAmino;
}
export interface EventToggleSPAsDelegatedAgentSDKType {
    bucket_name: string;
    bucket_id: string;
    sp_as_delegated_agent_disabled: boolean;
}
...
export declare const EventUpdateObjectContent: {
    typeUrl: string;
    encode(message: EventUpdateObjectContent, writer?: _m0.Writer): _m0.Writer;
    ...
    } & Record<Exclude<keyof I, keyof EventUpdateObjectContent>, never>>(object: I): EventUpdateObjectContent;
...
export declare const EventUpdateObjectContentSuccess: {
    typeUrl: string;
    encode(message: EventUpdateObjectContentSuccess, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends {
        ...
        objectName?: string;
        contentType?: string;
        prevPayloadSize?: string | number | Long.Long;
        newPayloadSize?: string | number | Long.Long;
        prevChecksums?: Uint8Array[];
        newChecksums?: Uint8Array[];
        version?: string | number | Long.Long;
        updatedAt?: string | number | Long.Long;
    } & {
        operator?: string;
        objectId?: string;
        bucketName?: string;
        ...
        prevPayloadSize?: string | number | (Long.Long & {
            ...
            toUnsigned: () => Long.Long;
            xor: (other: string | number | Long.Long) => Long.Long;
        } & Record<Exclude<keyof I["prevPayloadSize"], keyof Long.Long>, never>);
        newPayloadSize?: string | number | (Long.Long & {
            high: number;
            low: number;
            unsigned: boolean;
            ...
            toUnsigned: () => Long.Long;
            xor: (other: string | number | Long.Long) => Long.Long;
        } & Record<Exclude<keyof I["newPayloadSize"], keyof Long.Long>, never>);
        prevChecksums?: Uint8Array[] & Uint8Array[] & Record<Exclude<keyof I["prevChecksums"], keyof Uint8Array[]>, never>;
        newChecksums?: Uint8Array[] & Uint8Array[] & Record<Exclude<keyof I["newChecksums"], keyof Uint8Array[]>, never>;
        version?: string | number | (Long.Long & {
            high: number;
            low: number;
            unsigned: boolean;
        ...
        updatedAt?: string | number | (Long.Long & {
            ...
            toUnsigned: () => Long.Long;
            xor: (other: string | number | Long.Long) => Long.Long;
        } & Record<Exclude<keyof I["updatedAt"], keyof Long.Long>, never>);
    } & Record<Exclude<keyof I, keyof EventUpdateObjectContentSuccess>, never>>(object: I): EventUpdateObjectContentSuccess;
...
export declare const EventCancelUpdateObjectContent: {
    typeUrl: string;
    encode(message: EventCancelUpdateObjectContent, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial<I extends {
        ...
        objectName?: string;
        objectId?: string;
    } & Record<Exclude<keyof I, keyof EventCancelUpdateObjectContent>, never>>(object: I): EventCancelUpdateObjectContent;
...
export declare const EventSetBucketFlowRateLimit: {
    typeUrl: string;
    encode(message: EventSetBucketFlowRateLimit, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): EventSetBucketFlowRateLimit;
    fromJSON(object: any): EventSetBucketFlowRateLimit;
    toJSON(message: EventSetBucketFlowRateLimit): unknown;
    fromPartial<I extends {
        operator?: string;
        bucketName?: string;
        paymentAddress?: string;
        ...
        bucketOwner?: string;
        flowRateLimit?: string;
    } & Record<Exclude<keyof I, keyof EventSetBucketFlowRateLimit>, never>>(object: I): EventSetBucketFlowRateLimit;
    fromSDK(object: EventSetBucketFlowRateLimitSDKType): EventSetBucketFlowRateLimit;
    toSDK(message: EventSetBucketFlowRateLimit): EventSetBucketFlowRateLimitSDKType;
    fromAmino(object: EventSetBucketFlowRateLimitAmino): EventSetBucketFlowRateLimit;
    toAmino(message: EventSetBucketFlowRateLimit): EventSetBucketFlowRateLimitAmino;
    fromAminoMsg(object: EventSetBucketFlowRateLimitAminoMsg): EventSetBucketFlowRateLimit;
    fromProtoMsg(message: EventSetBucketFlowRateLimitProtoMsg): EventSetBucketFlowRateLimit;
    toProto(message: EventSetBucketFlowRateLimit): Uint8Array;
    toProtoMsg(message: EventSetBucketFlowRateLimit): EventSetBucketFlowRateLimitProtoMsg;
};
export declare const EventBucketFlowRateLimitStatus: {
    typeUrl: string;
    encode(message: EventBucketFlowRateLimitStatus, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): EventBucketFlowRateLimitStatus;
    fromJSON(object: any): EventBucketFlowRateLimitStatus;
    toJSON(message: EventBucketFlowRateLimitStatus): unknown;
    fromPartial<I extends {
        bucketName?: string;
        isLimited?: boolean;
        bucketId?: string;
        ...
        isLimited?: boolean;
        bucketId?: string;
    } & Record<Exclude<keyof I, keyof EventBucketFlowRateLimitStatus>, never>>(object: I): EventBucketFlowRateLimitStatus;
    fromSDK(object: EventBucketFlowRateLimitStatusSDKType): EventBucketFlowRateLimitStatus;
    toSDK(message: EventBucketFlowRateLimitStatus): EventBucketFlowRateLimitStatusSDKType;
    fromAmino(object: EventBucketFlowRateLimitStatusAmino): EventBucketFlowRateLimitStatus;
    toAmino(message: EventBucketFlowRateLimitStatus): EventBucketFlowRateLimitStatusAmino;
    fromAminoMsg(object: EventBucketFlowRateLimitStatusAminoMsg): EventBucketFlowRateLimitStatus;
    fromProtoMsg(message: EventBucketFlowRateLimitStatusProtoMsg): EventBucketFlowRateLimitStatus;
    toProto(message: EventBucketFlowRateLimitStatus): Uint8Array;
    toProtoMsg(message: EventBucketFlowRateLimitStatus): EventBucketFlowRateLimitStatusProtoMsg;
};
export declare const EventToggleSPAsDelegatedAgent: {
    typeUrl: string;
    encode(message: EventToggleSPAsDelegatedAgent, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): EventToggleSPAsDelegatedAgent;
    fromJSON(object: any): EventToggleSPAsDelegatedAgent;
    toJSON(message: EventToggleSPAsDelegatedAgent): unknown;
    fromPartial<I extends {
        bucketName?: string;
        bucketId?: string;
        spAsDelegatedAgentDisabled?: boolean;
        ...
        bucketId?: string;
        spAsDelegatedAgentDisabled?: boolean;
    } & Record<Exclude<keyof I, keyof EventToggleSPAsDelegatedAgent>, never>>(object: I): EventToggleSPAsDelegatedAgent;
    fromSDK(object: EventToggleSPAsDelegatedAgentSDKType): EventToggleSPAsDelegatedAgent;
    toSDK(message: EventToggleSPAsDelegatedAgent): EventToggleSPAsDelegatedAgentSDKType;
    fromAmino(object: EventToggleSPAsDelegatedAgentAmino): EventToggleSPAsDelegatedAgent;
    toAmino(message: EventToggleSPAsDelegatedAgent): EventToggleSPAsDelegatedAgentAmino;
    fromAminoMsg(object: EventToggleSPAsDelegatedAgentAminoMsg): EventToggleSPAsDelegatedAgent;
    fromProtoMsg(message: EventToggleSPAsDelegatedAgentProtoMsg): EventToggleSPAsDelegatedAgent;
    toProto(message: EventToggleSPAsDelegatedAgent): Uint8Array;
    toProtoMsg(message: EventToggleSPAsDelegatedAgent): EventToggleSPAsDelegatedAgentProtoMsg;
};
