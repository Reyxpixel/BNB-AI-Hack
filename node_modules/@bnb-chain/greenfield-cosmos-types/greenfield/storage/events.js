...
exports.EventRejectSealObject = {
    ...
    fromJSON(object) {
        return {
            ...
            objectName: (0, helpers_1.isSet)(object.objectName) ? String(object.objectName) : "",
            objectId: (0, helpers_1.isSet)(object.objectId) ? String(object.objectId) : "",
            forUpdate: (0, helpers_1.isSet)(object.forUpdate) ? Boolean(object.forUpdate) : false
        };
    },
    toJSON(message) {
        const obj = {};
...
function createBaseEventUpdateObjectContent() {
    return {
        operator: "",
        objectId: "",
        bucketName: "",
...
exports.EventUpdateObjectContent = {
    ...
    fromAminoMsg(object) {
        return exports.EventUpdateObjectContent.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventUpdateObjectContent.decode(message.value);
    },
    toProto(message) {
        return exports.EventUpdateObjectContent.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.EventUpdateObjectContent",
            value: exports.EventUpdateObjectContent.encode(message).finish()
        };
    }
};
function createBaseEventUpdateObjectContentSuccess() {
    return {
        operator: "",
        objectId: "",
        bucketName: "",
        objectName: "",
        contentType: "",
        prevPayloadSize: helpers_1.Long.UZERO,
        newPayloadSize: helpers_1.Long.UZERO,
        prevChecksums: [],
        newChecksums: [],
        version: helpers_1.Long.ZERO,
        updatedAt: helpers_1.Long.ZERO
    };
}
exports.EventUpdateObjectContentSuccess = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    message.prevPayloadSize = reader.uint64();
                    break;
                case 7:
                    message.newPayloadSize = reader.uint64();
                    break;
                case 8:
    ...
    fromJSON(object) {
        return {
            ...
            objectName: (0, helpers_1.isSet)(object.objectName) ? String(object.objectName) : "",
            contentType: (0, helpers_1.isSet)(object.contentType) ? String(object.contentType) : "",
            prevPayloadSize: (0, helpers_1.isSet)(object.prevPayloadSize) ? helpers_1.Long.fromValue(object.prevPayloadSize) : helpers_1.Long.UZERO,
            newPayloadSize: (0, helpers_1.isSet)(object.newPayloadSize) ? helpers_1.Long.fromValue(object.newPayloadSize) : helpers_1.Long.UZERO,
            prevChecksums: Array.isArray(object?.prevChecksums) ? object.prevChecksums.map((e) => (0, helpers_1.bytesFromBase64)(e)) : [],
            newChecksums: Array.isArray(object?.newChecksums) ? object.newChecksums.map((e) => (0, helpers_1.bytesFromBase64)(e)) : [],
            version: (0, helpers_1.isSet)(object.version) ? helpers_1.Long.fromValue(object.version) : helpers_1.Long.ZERO,
            updatedAt: (0, helpers_1.isSet)(object.updatedAt) ? helpers_1.Long.fromValue(object.updatedAt) : helpers_1.Long.ZERO
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.objectName !== undefined && (obj.objectName = message.objectName);
        message.contentType !== undefined && (obj.contentType = message.contentType);
        message.prevPayloadSize !== undefined && (obj.prevPayloadSize = (message.prevPayloadSize || helpers_1.Long.UZERO).toString());
        message.newPayloadSize !== undefined && (obj.newPayloadSize = (message.newPayloadSize || helpers_1.Long.UZERO).toString());
        if (message.prevChecksums) {
            obj.prevChecksums = message.prevChecksums.map(e => (0, helpers_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.prevChecksums = [];
        }
        if (message.newChecksums) {
            obj.newChecksums = message.newChecksums.map(e => (0, helpers_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.newChecksums = [];
        }
        message.version !== undefined && (obj.version = (message.version || helpers_1.Long.ZERO).toString());
        message.updatedAt !== undefined && (obj.updatedAt = (message.updatedAt || helpers_1.Long.ZERO).toString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseEventUpdateObjectContentSuccess();
        ...
        message.objectName = object.objectName ?? "";
        message.contentType = object.contentType ?? "";
        message.prevPayloadSize = object.prevPayloadSize !== undefined && object.prevPayloadSize !== null ? helpers_1.Long.fromValue(object.prevPayloadSize) : helpers_1.Long.UZERO;
        message.newPayloadSize = object.newPayloadSize !== undefined && object.newPayloadSize !== null ? helpers_1.Long.fromValue(object.newPayloadSize) : helpers_1.Long.UZERO;
        message.prevChecksums = object.prevChecksums?.map(e => e) || [];
        message.newChecksums = object.newChecksums?.map(e => e) || [];
        message.version = object.version !== undefined && object.version !== null ? helpers_1.Long.fromValue(object.version) : helpers_1.Long.ZERO;
        message.updatedAt = object.updatedAt !== undefined && object.updatedAt !== null ? helpers_1.Long.fromValue(object.updatedAt) : helpers_1.Long.ZERO;
        return message;
    },
    fromSDK(object) {
        return {
            ...
            prevChecksums: Array.isArray(object?.prev_checksums) ? object.prev_checksums.map((e) => e) : [],
            newChecksums: Array.isArray(object?.new_checksums) ? object.new_checksums.map((e) => e) : [],
            version: object?.version,
    ...
    fromAmino(object) {
        ...
        if (object.prev_payload_size !== undefined && object.prev_payload_size !== null) {
            message.prevPayloadSize = helpers_1.Long.fromString(object.prev_payload_size);
        }
        if (object.new_payload_size !== undefined && object.new_payload_size !== null) {
            message.newPayloadSize = helpers_1.Long.fromString(object.new_payload_size);
        }
        message.prevChecksums = object.prev_checksums?.map(e => (0, helpers_1.bytesFromBase64)(e)) || [];
        message.newChecksums = object.new_checksums?.map(e => (0, helpers_1.bytesFromBase64)(e)) || [];
        if (object.version !== undefined && object.version !== null) {
            message.version = helpers_1.Long.fromString(object.version);
        }
        if (object.updated_at !== undefined && object.updated_at !== null) {
            message.updatedAt = helpers_1.Long.fromString(object.updated_at);
        }
        return message;
    },
    toAmino(message) {
        ...
        if (message.prevChecksums) {
            obj.prev_checksums = message.prevChecksums.map(e => (0, helpers_1.base64FromBytes)(e));
        }
        else {
            obj.prev_checksums = [];
        }
        if (message.newChecksums) {
            obj.new_checksums = message.newChecksums.map(e => (0, helpers_1.base64FromBytes)(e));
        }
        else {
            obj.new_checksums = [];
        }
    ...
    fromAminoMsg(object) {
        return exports.EventUpdateObjectContentSuccess.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventUpdateObjectContentSuccess.decode(message.value);
    },
    toProto(message) {
        return exports.EventUpdateObjectContentSuccess.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.EventUpdateObjectContentSuccess",
            value: exports.EventUpdateObjectContentSuccess.encode(message).finish()
        };
    }
};
function createBaseEventCancelUpdateObjectContent() {
    return {
        operator: "",
        bucketName: "",
        objectName: "",
...
exports.EventCancelUpdateObjectContent = {
    ...
    fromAminoMsg(object) {
        return exports.EventCancelUpdateObjectContent.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventCancelUpdateObjectContent.decode(message.value);
    },
    toProto(message) {
        return exports.EventCancelUpdateObjectContent.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.EventCancelUpdateObjectContent",
            value: exports.EventCancelUpdateObjectContent.encode(message).finish()
        };
    }
};
function createBaseEventSetBucketFlowRateLimit() {
    return {
        operator: "",
        bucketName: "",
        paymentAddress: "",
...
exports.EventSetBucketFlowRateLimit = {
    typeUrl: "/greenfield.storage.EventSetBucketFlowRateLimit",
    encode(message, writer = _m0.Writer.create()) {
        if (message.operator !== "") {
            writer.uint32(10).string(message.operator);
        }
        ...
        if (message.bucketOwner !== "") {
            writer.uint32(34).string(message.bucketOwner);
        }
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseEventSetBucketFlowRateLimit();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromAminoMsg(object) {
        return exports.EventSetBucketFlowRateLimit.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventSetBucketFlowRateLimit.decode(message.value);
    },
    toProto(message) {
        return exports.EventSetBucketFlowRateLimit.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.EventSetBucketFlowRateLimit",
            value: exports.EventSetBucketFlowRateLimit.encode(message).finish()
        };
    }
};
function createBaseEventBucketFlowRateLimitStatus() {
    return {
        bucketName: "",
        isLimited: false,
        bucketId: ""
...
exports.EventBucketFlowRateLimitStatus = {
    typeUrl: "/greenfield.storage.EventBucketFlowRateLimitStatus",
    encode(message, writer = _m0.Writer.create()) {
        if (message.bucketName !== "") {
            writer.uint32(10).string(message.bucketName);
        }
        if (message.isLimited === true) {
            writer.uint32(16).bool(message.isLimited);
        }
        if (message.bucketId !== "") {
            writer.uint32(26).string(message.bucketId);
        }
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseEventBucketFlowRateLimitStatus();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return {
            bucketName: (0, helpers_1.isSet)(object.bucketName) ? String(object.bucketName) : "",
            isLimited: (0, helpers_1.isSet)(object.isLimited) ? Boolean(object.isLimited) : false,
            bucketId: (0, helpers_1.isSet)(object.bucketId) ? String(object.bucketId) : ""
        };
    },
    toJSON(message) {
    ...
    toSDK(message) {
        const obj = {};
        obj.bucket_name = message.bucketName;
        obj.is_limited = message.isLimited;
        obj.bucket_id = message.bucketId;
        return obj;
    },
    fromAmino(object) {
        ...
        if (object.is_limited !== undefined && object.is_limited !== null) {
            message.isLimited = object.is_limited;
        }
        if (object.bucket_id !== undefined && object.bucket_id !== null) {
            message.bucketId = object.bucket_id;
        }
    ...
    fromAminoMsg(object) {
        return exports.EventBucketFlowRateLimitStatus.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventBucketFlowRateLimitStatus.decode(message.value);
    },
    toProto(message) {
        return exports.EventBucketFlowRateLimitStatus.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.EventBucketFlowRateLimitStatus",
            value: exports.EventBucketFlowRateLimitStatus.encode(message).finish()
        };
    }
};
function createBaseEventToggleSPAsDelegatedAgent() {
    return {
        bucketName: "",
        bucketId: "",
...
exports.EventToggleSPAsDelegatedAgent = {
    typeUrl: "/greenfield.storage.EventToggleSPAsDelegatedAgent",
    encode(message, writer = _m0.Writer.create()) {
        if (message.bucketName !== "") {
            writer.uint32(10).string(message.bucketName);
        }
        ...
        if (message.spAsDelegatedAgentDisabled === true) {
            writer.uint32(24).bool(message.spAsDelegatedAgentDisabled);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseEventToggleSPAsDelegatedAgent();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        return {
            bucketName: (0, helpers_1.isSet)(object.bucketName) ? String(object.bucketName) : "",
            bucketId: (0, helpers_1.isSet)(object.bucketId) ? String(object.bucketId) : "",
            spAsDelegatedAgentDisabled: (0, helpers_1.isSet)(object.spAsDelegatedAgentDisabled) ? Boolean(object.spAsDelegatedAgentDisabled) : false
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromAminoMsg(object) {
        return exports.EventToggleSPAsDelegatedAgent.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventToggleSPAsDelegatedAgent.decode(message.value);
    },
    toProto(message) {
        return exports.EventToggleSPAsDelegatedAgent.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.EventToggleSPAsDelegatedAgent",
            value: exports.EventToggleSPAsDelegatedAgent.encode(message).finish()
        };
    }
};
