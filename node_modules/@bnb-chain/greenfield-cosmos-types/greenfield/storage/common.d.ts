...
export interface BucketFlowRateLimit {
    /** flow_rate_limit defines the flow rate limit of the bucket */
    flowRateLimit: string;
}
export interface BucketFlowRateLimitProtoMsg {
    typeUrl: "/greenfield.storage.BucketFlowRateLimit";
    value: Uint8Array;
}
export interface BucketFlowRateLimitAmino {
    /** flow_rate_limit defines the flow rate limit of the bucket */
    flow_rate_limit?: string;
}
export interface BucketFlowRateLimitAminoMsg {
    type: "/greenfield.storage.BucketFlowRateLimit";
    value: BucketFlowRateLimitAmino;
}
export interface BucketFlowRateLimitSDKType {
    flow_rate_limit: string;
}
export interface BucketFlowRateLimitStatus {
    /** is_bucket_limited defines the flow rate limit status of the bucket, true means limited and the bucket is uncharged */
    isBucketLimited: boolean;
    /** payment_address is the payment address of the bucket which limited the flow rate */
    paymentAddress: string;
}
export interface BucketFlowRateLimitStatusProtoMsg {
    typeUrl: "/greenfield.storage.BucketFlowRateLimitStatus";
    value: Uint8Array;
}
export interface BucketFlowRateLimitStatusAmino {
    /** is_bucket_limited defines the flow rate limit status of the bucket, true means limited and the bucket is uncharged */
    is_bucket_limited?: boolean;
    /** payment_address is the payment address of the bucket which limited the flow rate */
    payment_address?: string;
}
export interface BucketFlowRateLimitStatusAminoMsg {
    type: "/greenfield.storage.BucketFlowRateLimitStatus";
    value: BucketFlowRateLimitStatusAmino;
}
export interface BucketFlowRateLimitStatusSDKType {
    is_bucket_limited: boolean;
    payment_address: string;
}
...
export declare const BucketFlowRateLimit: {
    typeUrl: string;
    encode(message: BucketFlowRateLimit, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): BucketFlowRateLimit;
    fromJSON(object: any): BucketFlowRateLimit;
    toJSON(message: BucketFlowRateLimit): unknown;
    fromPartial<I extends {
        flowRateLimit?: string;
    } & {
        flowRateLimit?: string;
    } & Record<Exclude<keyof I, "flowRateLimit">, never>>(object: I): BucketFlowRateLimit;
    fromSDK(object: BucketFlowRateLimitSDKType): BucketFlowRateLimit;
    toSDK(message: BucketFlowRateLimit): BucketFlowRateLimitSDKType;
    fromAmino(object: BucketFlowRateLimitAmino): BucketFlowRateLimit;
    toAmino(message: BucketFlowRateLimit): BucketFlowRateLimitAmino;
    fromAminoMsg(object: BucketFlowRateLimitAminoMsg): BucketFlowRateLimit;
    fromProtoMsg(message: BucketFlowRateLimitProtoMsg): BucketFlowRateLimit;
    toProto(message: BucketFlowRateLimit): Uint8Array;
    toProtoMsg(message: BucketFlowRateLimit): BucketFlowRateLimitProtoMsg;
};
export declare const BucketFlowRateLimitStatus: {
    typeUrl: string;
    encode(message: BucketFlowRateLimitStatus, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): BucketFlowRateLimitStatus;
    fromJSON(object: any): BucketFlowRateLimitStatus;
    toJSON(message: BucketFlowRateLimitStatus): unknown;
    fromPartial<I extends {
        isBucketLimited?: boolean;
        paymentAddress?: string;
    } & {
        isBucketLimited?: boolean;
        paymentAddress?: string;
    } & Record<Exclude<keyof I, keyof BucketFlowRateLimitStatus>, never>>(object: I): BucketFlowRateLimitStatus;
    fromSDK(object: BucketFlowRateLimitStatusSDKType): BucketFlowRateLimitStatus;
    toSDK(message: BucketFlowRateLimitStatus): BucketFlowRateLimitStatusSDKType;
    fromAmino(object: BucketFlowRateLimitStatusAmino): BucketFlowRateLimitStatus;
    toAmino(message: BucketFlowRateLimitStatus): BucketFlowRateLimitStatusAmino;
    fromAminoMsg(object: BucketFlowRateLimitStatusAminoMsg): BucketFlowRateLimitStatus;
    fromProtoMsg(message: BucketFlowRateLimitStatusProtoMsg): BucketFlowRateLimitStatus;
    toProto(message: BucketFlowRateLimitStatus): Uint8Array;
    toProtoMsg(message: BucketFlowRateLimitStatus): BucketFlowRateLimitStatusProtoMsg;
};
