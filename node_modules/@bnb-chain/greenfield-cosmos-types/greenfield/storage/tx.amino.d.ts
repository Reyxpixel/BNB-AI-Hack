...
export declare const AminoConverter: {
    ...
    "/greenfield.storage.MsgToggleSPAsDelegatedAgent": {
        aminoType: string;
        toAmino: (message: MsgToggleSPAsDelegatedAgent) => import("./tx").MsgToggleSPAsDelegatedAgentAmino;
        fromAmino: (object: import("./tx").MsgToggleSPAsDelegatedAgentAmino) => MsgToggleSPAsDelegatedAgent;
    };
    ...
    "/greenfield.storage.MsgSealObjectV2": {
        aminoType: string;
        toAmino: (message: MsgSealObjectV2) => import("./tx").MsgSealObjectV2Amino;
        fromAmino: (object: import("./tx").MsgSealObjectV2Amino) => MsgSealObjectV2;
    };
    ...
    "/greenfield.storage.MsgUpdateObjectContent": {
        aminoType: string;
        toAmino: (message: MsgUpdateObjectContent) => import("./tx").MsgUpdateObjectContentAmino;
        fromAmino: (object: import("./tx").MsgUpdateObjectContentAmino) => MsgUpdateObjectContent;
    };
    "/greenfield.storage.MsgCancelUpdateObjectContent": {
        aminoType: string;
        toAmino: (message: MsgCancelUpdateObjectContent) => import("./tx").MsgCancelUpdateObjectContentAmino;
        fromAmino: (object: import("./tx").MsgCancelUpdateObjectContentAmino) => MsgCancelUpdateObjectContent;
    };
    "/greenfield.storage.MsgDelegateCreateObject": {
        aminoType: string;
        toAmino: (message: MsgDelegateCreateObject) => import("./tx").MsgDelegateCreateObjectAmino;
        fromAmino: (object: import("./tx").MsgDelegateCreateObjectAmino) => MsgDelegateCreateObject;
    };
    "/greenfield.storage.MsgDelegateUpdateObjectContent": {
        aminoType: string;
        toAmino: (message: MsgDelegateUpdateObjectContent) => import("./tx").MsgDelegateUpdateObjectContentAmino;
        fromAmino: (object: import("./tx").MsgDelegateUpdateObjectContentAmino) => MsgDelegateUpdateObjectContent;
    };
    ...
    "/greenfield.storage.MsgSetBucketFlowRateLimit": {
        aminoType: string;
        toAmino: (message: MsgSetBucketFlowRateLimit) => import("./tx").MsgSetBucketFlowRateLimitAmino;
        fromAmino: (object: import("./tx").MsgSetBucketFlowRateLimitAmino) => MsgSetBucketFlowRateLimit;
    };
};
