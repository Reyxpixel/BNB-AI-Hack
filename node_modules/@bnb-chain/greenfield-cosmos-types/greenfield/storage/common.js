...
function createBaseBucketFlowRateLimit() {
    return {
        flowRateLimit: ""
    };
}
exports.BucketFlowRateLimit = {
    typeUrl: "/greenfield.storage.BucketFlowRateLimit",
    encode(message, writer = _m0.Writer.create()) {
        if (message.flowRateLimit !== "") {
            writer.uint32(10).string(message.flowRateLimit);
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseBucketFlowRateLimit();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromAminoMsg(object) {
        return exports.BucketFlowRateLimit.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.BucketFlowRateLimit.decode(message.value);
    },
    toProto(message) {
        return exports.BucketFlowRateLimit.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.BucketFlowRateLimit",
            value: exports.BucketFlowRateLimit.encode(message).finish()
        };
    }
};
function createBaseBucketFlowRateLimitStatus() {
    return {
        isBucketLimited: false,
        paymentAddress: ""
    };
}
exports.BucketFlowRateLimitStatus = {
    typeUrl: "/greenfield.storage.BucketFlowRateLimitStatus",
    encode(message, writer = _m0.Writer.create()) {
        if (message.isBucketLimited === true) {
            writer.uint32(8).bool(message.isBucketLimited);
        }
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseBucketFlowRateLimitStatus();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.isBucketLimited = reader.bool();
                    break;
                case 2:
    ...
    fromJSON(object) {
        return {
            isBucketLimited: (0, helpers_1.isSet)(object.isBucketLimited) ? Boolean(object.isBucketLimited) : false,
            paymentAddress: (0, helpers_1.isSet)(object.paymentAddress) ? String(object.paymentAddress) : ""
        };
    },
    toJSON(message) {
        const obj = {};
        message.isBucketLimited !== undefined && (obj.isBucketLimited = message.isBucketLimited);
        message.paymentAddress !== undefined && (obj.paymentAddress = message.paymentAddress);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseBucketFlowRateLimitStatus();
        message.isBucketLimited = object.isBucketLimited ?? false;
        message.paymentAddress = object.paymentAddress ?? "";
        return message;
    },
    fromSDK(object) {
        return {
            isBucketLimited: object?.is_bucket_limited,
            paymentAddress: object?.payment_address
        };
    },
    toSDK(message) {
        const obj = {};
        obj.is_bucket_limited = message.isBucketLimited;
        obj.payment_address = message.paymentAddress;
        return obj;
    },
    fromAmino(object) {
        const message = createBaseBucketFlowRateLimitStatus();
        if (object.is_bucket_limited !== undefined && object.is_bucket_limited !== null) {
            message.isBucketLimited = object.is_bucket_limited;
        }
    ...
    fromAminoMsg(object) {
        return exports.BucketFlowRateLimitStatus.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.BucketFlowRateLimitStatus.decode(message.value);
    },
    toProto(message) {
        return exports.BucketFlowRateLimitStatus.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.storage.BucketFlowRateLimitStatus",
            value: exports.BucketFlowRateLimitStatus.encode(message).finish()
        };
    }
};
