...
export interface BucketExtraInfo {
    isRateLimited: boolean;
    flowRateLimit: string;
    currentFlowRate: string;
}
export interface BucketExtraInfoProtoMsg {
    typeUrl: "/greenfield.storage.BucketExtraInfo";
    value: Uint8Array;
}
export interface BucketExtraInfoAmino {
    is_rate_limited?: boolean;
    flow_rate_limit?: string;
    current_flow_rate?: string;
}
export interface BucketExtraInfoAminoMsg {
    type: "/greenfield.storage.BucketExtraInfo";
    value: BucketExtraInfoAmino;
}
export interface BucketExtraInfoSDKType {
    is_rate_limited: boolean;
    flow_rate_limit: string;
    current_flow_rate: string;
}
...
export declare const ShadowObjectInfo: {
    typeUrl: string;
    encode(message: ShadowObjectInfo, writer?: _m0.Writer): _m0.Writer;
    ...
    } & Record<Exclude<keyof I, keyof ShadowObjectInfo>, never>>(object: I): ShadowObjectInfo;
...
export declare const BucketExtraInfo: {
    typeUrl: string;
    encode(message: BucketExtraInfo, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): BucketExtraInfo;
    fromJSON(object: any): BucketExtraInfo;
    toJSON(message: BucketExtraInfo): unknown;
    fromPartial<I extends {
        isRateLimited?: boolean;
        flowRateLimit?: string;
        currentFlowRate?: string;
        ...
        flowRateLimit?: string;
        currentFlowRate?: string;
    } & Record<Exclude<keyof I, keyof BucketExtraInfo>, never>>(object: I): BucketExtraInfo;
    fromSDK(object: BucketExtraInfoSDKType): BucketExtraInfo;
    toSDK(message: BucketExtraInfo): BucketExtraInfoSDKType;
    fromAmino(object: BucketExtraInfoAmino): BucketExtraInfo;
    toAmino(message: BucketExtraInfo): BucketExtraInfoAmino;
    fromAminoMsg(object: BucketExtraInfoAminoMsg): BucketExtraInfo;
    fromProtoMsg(message: BucketExtraInfoProtoMsg): BucketExtraInfo;
    toProto(message: BucketExtraInfo): Uint8Array;
    toProtoMsg(message: BucketExtraInfo): BucketExtraInfoProtoMsg;
};
